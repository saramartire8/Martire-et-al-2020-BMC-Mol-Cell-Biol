...
#SBATCH --job-name=ChIP-Seq                      # job name
...
#SBATCH --mail-user=sara1.martire@utsouthwestern.edu      # specify an email address
...
set FILE=/project/GCRB/Banaszynski_lab/shared/path-to-folder/ChIP-Seq
